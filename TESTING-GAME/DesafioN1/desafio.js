...
function elevarAlCuadrado(num) {
  ...
  // Tu código:
  let respuesta = num * num; // num ** 2 // Math.pow(num, 2)
  return respuesta;
}
...
function elevarAlCubo(num) {
  ...
  let respuesta = num * num * num; // num ** 3 // Math.pow(num, 3)
...
function elevar(num, exponent) {
  ...
  // Tu código:
  let producto = num ** exponent; // Math.pow(num, exponent)
  return producto;
}
...
function esPositivo(numero) {
  ...
  if (numero > 0) return "Este numero es positivo";
  if (numero < 0) return "Este numero es negativo";
